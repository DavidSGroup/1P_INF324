...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <h1 class="mt-5">Editar los datos del usuario: <?php echo $nconpleto; ?></h1>
        <form action="<?php echo base_url(); ?>usuario/update/<?php echo $id; ?>" class="mt-4" method="POST">
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1">Nombre completo</label>
                        <input type="text" name="fullName" class="form-control <?php echo form_error('fullName') ? 'is-invalid':'' ; ?>" placeholder="Nombre completo" value="<?php echo $nconpleto; ?>">
